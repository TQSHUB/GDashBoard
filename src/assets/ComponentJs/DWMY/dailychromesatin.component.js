function cvsInspectionDaily(Ilabels, Idata1, Idata2, Idata3, Idata4, Idata5){
            var dLabels = Ilabels;
            var dData1 = Idata1;
            var dData2 = Idata2;
            var dData3 = Idata3;
...
function cvsRoundLineDaily(Rlabels, Rdata, Pdata, Edata){
            var cdata = Rdata;
            var clabels = Rlabels;
            var pdata = Pdata;
            var emdata = Edata;
...
function cvsRDefectDaily(RDlabels, RDdata){
            var dData = RDdata;
...
function cvsTopDefectDaily(Tlabels, Tdata1, Tdata2, Tdata3, Tdata4, Tdata5, Legents1, Legents2, Legents3, Legents4, Legents5){
            var dLabels = Tlabels;
            var dData1 = Tdata1;
            var dData2 = Tdata2;
            var dData3 = Tdata3;
...
function pieChartDaily(Dlabels, Ddata){
            var cdata = Ddata;
            var clabels = Dlabels;
